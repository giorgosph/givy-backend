...
INSERT INTO "draw_item" ("draw_id", "title", "category", "description", "brief", "price")
VALUES
  (1, 'Digital Camera', 'electronics', 'High-quality digital camera for capturing moments', 'Capture memories in high resolution', 300),
  ...
  (3, 'Yoga Retreat', 'vacation', 'Relaxing yoga retreat in a scenic location', 'Rejuvenate your mind and body in nature', 200),
